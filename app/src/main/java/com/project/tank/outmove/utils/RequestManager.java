...
/**
 * Created by linweijie on 2018/10/31.
 */
...
public class RequestManager {
    ...
    private static final String BASE_URL = "http://";//请求接口根地址
        ...
        try {
            ...
            for (String key : paramsMap.keySet()) {
                ...
                if (!(object instanceof File)) {
                    ...
                    builder.addFormDataPart("file", file.getName(), RequestBody.create(MEDIA_OBJECT_STREAM, file));
                }
            }
            //创建RequestBody
